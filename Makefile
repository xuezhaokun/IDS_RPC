...
clean:
	 rm -f structsclient structsserver floatarithmeticclient floatarithmeticserver arithmeticclient arithmeticserver pingstreamclient pingstreamserver idldeclarationtst idl_to_json simplefunctionclient simplefunctionserver *.o *.json *.pyc
